...
public class PassTime : MonoBehaviour
{
    ...
    // UI Elements
    [Header("UI Elements")]
    public UnityEngine.GameObject passTimeUI;
    public Text addTimeUI;
    public Text ClockTimeUI;
    public Text DateUI;
    public UnityEngine.GameObject blackScreen;

    // Buttons
    [Header("Buttons")]
    [SerializeField] private UnityEngine.GameObject startPassTimeButton;
    [SerializeField] private UnityEngine.GameObject addTimeButton;
    [SerializeField] private UnityEngine.GameObject decreaseTimeButton;
    [SerializeField] private UnityEngine.GameObject cancelButton;

    // Death by Days
    [Header("Deadline")]
    [SerializeField] private UnityEngine.GameObject deathMenuUI;
    [SerializeField] private Text deathMenuText;
