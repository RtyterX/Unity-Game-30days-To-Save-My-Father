...
public class DialogueScript : MonoBehaviour
{
    ...
    // Components
    [Header("Components")]
    [SerializeField] private UnityEngine.GameObject dialogBox;
    [SerializeField] private Text dialogText;
    [SerializeField] private UnityEngine.GameObject player;
    [SerializeField] private UnityEngine.GameObject passTextButton;
    ...
    {
        // Components
        componentManager = UnityEngine.GameObject.FindGameObjectWithTag("Component Manager").GetComponent<ComponentManager>();
        ...
        if (Input.GetAxisRaw("Interect") != 0 && PlayerCanStartDialog && passText)
        {
            ...
            if (dialogBox.activeInHierarchy)
            {
                ...
                if (currentDialogue >= dialog.Length)
                {
                    ...
                    // Change Player Behaviour Status
            ...
            else
            {
                ...
                // Change Player Behaviour Status and Animation
                PlayerBehaviour playerB = player.GetComponent<PlayerBehaviour>();
